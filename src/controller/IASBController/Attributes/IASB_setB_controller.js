const IASB_setB_model = require("../../../model/Attributes/IASB_setB_model");
const getAllFiles = require("../../../utils/getAllFiles");
const fs = require('fs');
const path = require('path');
const { execSync } = require("child_process"); 
const SaxonJS = require('saxon-js');
const zipFilePath = path.join(__dirname, '../../../../output/IASB_SetB');
const IASB_setB_controller = async (req, res) => {
    try {
        ...
        await IASB_setB_model.insertMany(uniqueTagsArray, { ordered: false })
            .catch(err => {
                if (err.code !== 11000) { 
                    throw err;
                }
